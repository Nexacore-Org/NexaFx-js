...
export class CreateDevices20260328000001 implements MigrationInterface {
  name = 'CreateDevices20260328000001';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX IF NOT EXISTS "UQ_devices_user_deviceKey" ON "devices" ("userId", "deviceKey")`,
    );
  }
