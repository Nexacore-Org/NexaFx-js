...
export class RbacAdminController {
  ...
  @ApiOperation({ summary: 'List all roles with inheritance chain' })
  listRoles() {
  ...
  deleteRole(@Param('id', ParseUUIDPipe) id: string, @CurrentUser('id') actorId: string) {
  ...
  assignRolesToUser(@Body() dto: AssignRolesToUserDto, @CurrentUser('id') actorId: string) {
  ...
  async getUserPermissions(@Param('userId', ParseUUIDPipe) userId: string) {
    ...
    return { userId, roles: resolved.roles, permissions: [...resolved.permissions] };
  }
  ...
  getAuditLogs(@Query('take') take?: number, @Query('skip') skip?: number) {
